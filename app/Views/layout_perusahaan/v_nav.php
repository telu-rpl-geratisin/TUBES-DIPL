<body class="hold-transition layout-top-nav">
  ...
  <div class="container d-flex justify-content-between">
      ...
      <ul>
          <li><a class="nav-link scrollto active" href="<?= base_url('perusahaan') ?>">Home</a></li>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-body">
                  <div class="row">
                    <span class="col-xs-4 text-center">
                      <a href="#"><?= session()->get('contact_person') ?>|<?= session()->get('kode_pos') ?>|<?= session()->get('rating') ?> </a>
                    </span>
                  </div>
                  <!-- /.row -->
                </li>
                ...
                <li class="user-footer">
                  <div class="col-xs-4 text-center">
                    <a href="<?= base_url('Profile_Perusahaan') ?>" class="btn btn-default btn-flat">Profile</a>
                  </div>
