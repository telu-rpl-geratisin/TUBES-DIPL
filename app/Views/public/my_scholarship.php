                  ...
                  switch ($scholarship['status']) {
                    ...
                    default:
                        break;
		      			...
		      			<td><?= $badge ?></td>
		      			<td>
		      				<a href="<?= base_url() ?>/pub/scholarship/<?= $scholarship['id'] ?>" class="btn btn-primary">Lihat</a>
		      				<a href="<?= base_url() ?>/pub/edit_scholarship/<?= $scholarship['id'] ?>" class="btn btn-primary">Edit</a>
		      				<a href="<?= base_url() ?>/pub/verify_scholarship/<?= $scholarship['id'] ?>" class="btn btn-primary <?= $scholarship['status'] == 'verified' ? 'disabled' : '' ?>">Verifikasi</a>
		      			</td>
		      		</tr>
		      	<?php endforeach ?>
		      </tbody>
