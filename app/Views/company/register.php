...
<html lang="en">
  <head>
    ...
    <title>Mendaftar Perusahaan | Geratisin</title>
...
<div class="container">
  <div class="py-5 text-center">
    <h1 class="font-weight-bolder">Geratisin</h1>
  ...
  <div class="row justify-content-center">
    <div class="" style="width: 100%; max-width: 400px;">
      ...
      <form action="<?= base_url() ?>/company/register" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>
        <div class="mb-3">
        ...
        <div class="form-group mb-3">
          <label for="uploadPhoto">Upload Foto Profil Perusahaan <span class="text-muted">(Opsional)</span></label>
          <input name="photo" type="file" class="form-control-file" id="uploadPhoto">
        </div>

        <div class="mb-3">
          <label for="contact">Kontak <span class="text-muted">(Opsional)</span></label>
        ...
        <hr class="my-3">
        <p>Sudah punya akun? Kembali ke halaman <a href="<?= base_url() ?>/company/login">Login</a></p>
      </form>
    </div>
  </div>
