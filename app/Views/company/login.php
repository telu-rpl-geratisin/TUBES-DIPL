...
<html lang="en">
  <head>
    ...
    <title>Login Perusahaan | Geratisin</title>
...
<form action="<?= base_url() ?>/company/login" method="post" class="form-signin">
  <?= csrf_field() ?>
  ...
  <p>Belum punya akun? <a href="<?= base_url() ?>/company/register">Mendaftar sekarang</a></p>
